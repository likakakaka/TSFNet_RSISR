...
def create_dataloaders(args):
    ...
    if args.dataset == 'AID':
        ...
        training_set = NWPUDataset(args, root_dir='G:\datasets\yaogan\dataset/NWPU-RESISC45/train',
                                 train=True)
        test_set = NWPUDataset(args, root_dir='G:\datasets\yaogan\dataset/NWPU-RESISC45/val',
                                  train=False)
    else:
